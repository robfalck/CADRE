...
from CADRE.orbit.EOMs import TwoBodyDynamicsComp
from CADRE.orbit.EOMs.perturbations.perturbations import Perturbations
from CADRE.orbit.frame_conversions import MEEToCart
...
class TwoBodyEOM(om.Group):
    ...
    def setup(self):
        ...
        self.add_subsystem('perturbations', subsys=Perturbations(num_nodes=nn, sc_params=sc_params, central_body=cb),
                           promotes_inputs=['T_r', 'T_s', 'T_w', 'x', 'y', 'z', 'vx', 'vy', 'vz', 'time'],
